            ...
            {!isLoading &&
              tiers.map((tier) => (
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <span className="inline-flex h-8 min-w-8 items-center justify-center rounded-lg bg-violet-50 px-2 text-sm font-black text-violet-600 backoffice-dark:bg-[var(--backoffice-primary-soft)] backoffice-dark:text-[var(--backoffice-primary)]">
                      {tier.tierLevel}
                    </span>
                  </td>
                  <td className="px-5 py-4">
