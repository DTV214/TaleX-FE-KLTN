...
// Bảng dịch nhãn AWS Rekognition -> tiếng Việt giờ quản lý qua Admin CRUD (DB-backed),
// không còn hardcode ở đây — xem shared/hooks/use-violation-label-map.ts (render) và
// shared/utils/violation-label-translate.ts (pure fn dùng cả trong SSE handler imperative).
