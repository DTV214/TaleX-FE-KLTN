...
import { Plus, Edit3, Trash2, ListVideo, Layers, ChevronLeft } from "lucide-react";
    ...
    <div className="w-full py-6 text-creator-text">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          ...
          >
            <ChevronLeft className="h-4 w-4" /> Quay lại Series
          </button>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider ${season.status === "PUBLISHED" ? "bg-green-500/20 text-green-500 border border-green-500/20" :
