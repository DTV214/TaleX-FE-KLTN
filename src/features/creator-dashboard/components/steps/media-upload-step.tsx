  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full p-6 text-creator-text">
      ...
      <div className="flex-1 space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-white mb-1">Tải nội dung & AI kiểm duyệt</h2>
          <p className="text-sm text-creator-muted">Tải nội dung của bạn và đợi AI xác minh việc tuân thủ chính sách.</p>
        </div>

        <div className="bg-creator-sidebar border border-creator-border rounded-xl p-6 mt-8">
          <h3 className="font-semibold text-white mb-4">Khu vực làm việc</h3>
          ...
          {!uploaded ? (
            contentType === "VIDEO" ? (
              ...
              <div className="border-2 border-dashed border-creator-border hover:border-creator-gold/50 rounded-xl p-12 flex flex-col items-center justify-center text-center cursor-pointer transition-colors group">
                ...
                <h4 className="text-lg font-medium text-white mb-2">Kéo thả các trang truyện</h4>
          ...
          <div className="p-5 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-lg bg-creator-bg border border-creator-border">
                <span className="text-sm font-medium text-white">Quét chính sách</span>
                {isProcessing ? (
                  <span className="text-xs font-bold text-creator-gold animate-pulse">ĐANG QUÉT...</span>
                ) : isApproved ? (
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-creator-bg border border-creator-border">
                <span className="text-sm font-medium text-white">Bảo vệ bản quyền</span>
                {isProcessing ? (
                  <span className="text-xs font-bold text-creator-gold animate-pulse">ĐANG XÁC MINH...</span>
                ) : isApproved ? (
                  <CheckCircle2 size={16} className="text-green-500" />
                ) : (
                  <AlertTriangle size={16} className="text-red-500" />
