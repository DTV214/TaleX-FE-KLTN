...
export function DailyTopVideosRow() {
  const data: MediaItem[] = [
    {
      id: 501,
      title: "Bí Mật Huyền Thuật",
      subtitle: "Hoạt hình • 9 tập",
      badge: "Hạng 1",
    ...
    },
    {
      id: 502,
      title: "Biên Giới Số",
      subtitle: "Hành động, Khoa học viễn tưởng • 10 tập",
      badge: "Thịnh hành",
  ...
  return (
    <MediaRow
      ...
      description="Tuyển tập những bộ phim và hoạt hình không thể bỏ lỡ hôm nay."
