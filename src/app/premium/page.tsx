...
const heroSlides = [
  {
    ...
    description: "Xem phim, đọc truyện không quảng cáo.",
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col">
        ...
        <div className="flex items-start justify-between gap-2">
          <h3 className="mt-3 text-lg font-semibold tracking-normal text-white/90">
            {subscription.tier}
          </h3>
          <span className="mt-3 shrink-0 rounded-full bg-[#F5D46E]/15 px-2.5 py-0.5 text-sm font-bold tracking-wide text-[#F5D46E] ring-1 ring-[#F5D46E]/30">
...
function PricingSection() {
  ...
  // Sắp xếp tăng dần theo giá, lấy tối đa 3 gói
