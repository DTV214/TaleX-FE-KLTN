...
import { PremiumSubscriptionHistory } from "@/features/payment/components/premium-subscription-history";

export const metadata: Metadata = {
  title: "Lịch sử Premium | TaleX",
  description: "Theo dõi lịch sử các gói Premium đã mua trên TaleX.",
};
